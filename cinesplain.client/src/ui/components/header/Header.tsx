...
import { getPopularMoviesPath, retrieveMovies } from "../../../api/moviesApi.ts";
    ...
    return (
        <>
            ...
            <StyledAppBar className="center">
                <CenteredToolbar>
                    <NavBar onSearchButtonClicked={handleToggleModal} animateLogo={animateLogo} />
                </CenteredToolbar>
            </StyledAppBar>
        </>
    );
